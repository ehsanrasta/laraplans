...
namespace EhsanRasta\Laraplans\Tests;
...
class TestCase extends Testbench
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Set user model
        $app['config']->set('auth.providers.users.model', '\EhsanRasta\Laraplans\Tests\Models\User');
    ...
    {
        return ['EhsanRasta\Laraplans\LaraplansServiceProvider'];
    }
